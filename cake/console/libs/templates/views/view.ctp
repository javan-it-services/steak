 ...
 */
?>
<div class="<?php echo $pluralVar;?> view grid_12 alpha" id="content">
<div class="box">

<h2 class="section_name"><span class="section_name_span"><?php echo "<?php  __('{$singularHumanName}');?>";?></span></h2>
