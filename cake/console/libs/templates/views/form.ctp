 ...
 */
?>
<div class="<?php echo $pluralVar;?> form grid_12 alpha" id="content">
<div class="box">
<h2 class="section_name"><span class="section_name_span"><?php echo "<?php __('" . Inflector::humanize($action) . " {$singularHumanName}');?>";?></span></h2>
