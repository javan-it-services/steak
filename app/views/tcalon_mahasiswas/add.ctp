...
echo "<br>";
	...
	?>
			...
			<?php
				echo $form->input('TGL_DAFTAR',array('label'=>'Tanggal','type'=>'text', 'class'=>'w8em format-y-m-d divider-dash','value'=>date('d-M-Y')));
				...
				echo $form->input('PETUGAS', array('label'=>'Petugas','value'=>$user['User']['USERNAME']));
			...
			<?php
				...
				echo $form->input('tanggal_test',array('label'=>'Tanggal','type'=>'text', 'class'=>'w8em format-y-m-d divider-dash','value'=>date('d-M-Y')));
