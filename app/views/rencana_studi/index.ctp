...
<div class="rencana_kuliahs index grid_12 alpha " id="content">
	<div class="box">
		<h2 class="section_name"><span class="section_name_span"><?php __('Rencana Kuliah');?></span></h2>
...
<?php	echo $form->create("Filter",array("url"=>"/rencana_studi/index", 'class'=>'filter')); ?>
<table class="filter">
	<tr>
		<td>
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $html->link($html->image('pencil_48.png'), array('action'=>'add', $k['Tkelase']['KD_KULIAH']), array('title'=>'Isi Silabus Mingguan'),false,false); ?>
			<?php echo $html->link($html->image('paper_48.png'), array('action'=>'view', $k['Tkelase']['KD_KULIAH']), array('title'=>'Lihat Silabus Mingguan'),false,false); ?>
		</td>
	</tr>
