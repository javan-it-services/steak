...
<h2 class="section_name"><span class="section_name_span"><?php __('Tambah Perlengkapan Pendaftaran Baru');?></span></h2>
<?php echo $form->create('Tperlengkapan', array('id'=>'frm'));?>
	<div id="msg"></div>
	<fieldset>
	<?php
		echo $form->input('id');
		echo $form->input('jenis', array('label'=>'Jenis', 'div'=>'input text required'));
