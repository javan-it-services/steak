    ...
    <table cellpadding="0" cellspacing="0" class="Design">
        ...
        <tr>
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo $html->link($data_['TsilabusMingguan']['MINGGU_KE'],array('action'=>'../tsilabus_mingguan_kelases/view_minggu',$data_['TsilabusMingguan']['MINGGU_KE'])) ?></td>
                    <td><?php echo $data_['TsilabusMingguan']['TOPIK'] ?></td>
                    <td><?php echo $data_['TsilabusMingguan']['SUBTOPIK_KASUS'] ?></td>
                    <td>
                    <?php            
                    echo $html->link($data_['Tfile']['0']['nama_file'],array('action'=>'download',$data_['Tfile']['0']['nama_file']));
                    ?>
                    </td>
                <?php endforeach;?>
            </tbody>
