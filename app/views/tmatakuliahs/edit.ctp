<div class="tagamas form grid_12 alpha " id="content">
	<div class="box">
		<h2 class="section_name"><span class="section_name_span"><?php __('Edit Matakuliah');?></span></h2>
<?php echo $form->create('Tmatakuliah');?>
	<fieldset>
	<?php
		echo $form->input('KD_KULIAH', array('type'=>'text','label'=>__('Kode', true), 'readonly'=>'readonly', 'class'=>'disable'));
...
<div class="grid_4 omega" id="sidebar">
	...
	<ul>
		<li><?php echo $html->link(__('Hapus', true), array('action'=>'delete', $form->value('Tmatakuliah.KD_KULIAH')), array('class'=>'tombol minus'), "Anda yakin ?", false); ?></li>
	</ul>
	</div>
</div>
