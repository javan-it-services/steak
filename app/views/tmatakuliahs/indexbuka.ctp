<div class="tagamas index grid_12 alpha " id="content">
	<div class="box">
		<h2 class="section_name"><span class="section_name_span"><?php __('Mata Kuliah Dibuka');?></span></h2>
<?php echo $form->create('Filter', array('url'=>'/tmatakuliahs/indexbuka', 'class'=>'filter'))?>
<table class="filter">
	<tr>
		<td>
