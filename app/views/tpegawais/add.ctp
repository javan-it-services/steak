<div class="tpegawais form grid_12 alpha " id="content">
	<div class="box">
		<h2 class="section_name"><span class="section_name_span"><?php __('Tambah Data Pegawai');?></span></h2>

<?php echo $form->create('Tpegawai', array("action"=>"add", "type"=>"file"));?>
	<fieldset>
	<?php
...
<script type="text/javascript">
		function tampil($form){
			...
			$form.submit();
			$form.target ="";
			$form.action = "<?php echo $html->url("/tpegawais/add");?>";
