<div class="tdosens form grid_12 alpha " id="content">
	<div class="box">
		<h2 class="section_name"><span class="section_name_span"><?php __('Ubah Data Dosen');?></span></h2>

		<?php echo $form->create('Tdosen',array("type"=>"file"));?>
			<fieldset>
			<?php
				echo $form->input('NIP_DOSEN', array('type'=>'text', 'label'=>'NIP', 'readonly'=>'readonly', 'class'=>'disable'));
	...
	<script type="text/javascript">
		function tampil($form){
			...
			$form.submit();
			$form.target ="";
			$form.action = "<?php echo $html->url("/tdosens/edit");?>";
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Hapus', true), array('action'=>'delete', $form->value('Tdosen.NIP_DOSEN')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Tdosen.NIP_DOSEN'))); ?></li>
