<div class="tpengumumans index grid_12 alpha " id="content">
	<div class="box">
		<h2 class="section_name"><span class="section_name_span"><?php __('Data Pengumuman');?></span></h2>
...
<tr>
	...
	<th><?php echo $paginator->sort('Tanggal Mulai','tanggal_mulai');?></th>
	<th><?php echo $paginator->sort('Tanggal Berakhir','TGL_BERAKHIR');?></th>
	
	<th><?php echo $paginator->sort('Pembuat','ANNOUNCER');?></th>
...
?>
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $tpengumuman['Tpengumuman']['ANNOUNCER']; ?>
		</td>
		<td>
		...
		<td class="actions">
			...
			<?php echo $html->link($html->image('pencil_16.png'), array('action'=>'edit', $tpengumuman['Tpengumuman']['id']), array('title'=>'edit'),false,false); ?>
...
<div class="grid_4 omega" id="sidebar">
	<div class="sidebox special">
		<ul>
			<li><?php echo $html->link($html->image('add_16.png'). __('Tambah Pengumuman', true), array('action'=>'add'), array('class'=>'tombol'), null, false); ?></li>
		</ul>
	</div>
</div>